...
import type { EnhancedQuestion, QnaplusAppData } from "../../database";
...
const { querier } = defineProps<{
    querier: () => EnhancedQuestion[] | Promise<EnhancedQuestion[]>
}>();

const query = ref("");

const dbQuestions = useObservable<EnhancedQuestion[]>(
...
const selectedQuestion = ref<EnhancedQuestion | undefined>(undefined);
</script>

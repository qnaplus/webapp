...
<template>
	...
	<div ref="header"
		...
		<div class="flex gap-2">
			<Button as="a" href="https://nexus.qnapl.us" target="_blank" class="header-btn" icon="pi pi-discord"
				aria-label="Discord Server" text />
			<Button as="a" href="https://github.com/qnaplus" target="_blank" class="header-btn" icon="pi pi-github"
